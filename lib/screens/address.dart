    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            icon:Icon(Icons.arrow_back_ios_rounded, color: Colors.cyan[600],),
            onPressed: (){
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Text("Address", style: TextStyle(color: Colors.black, fontSize: vpH*0.025),),
                          Text("Confirmation", style: TextStyle(color: Colors.black, fontSize: vpH*0.025),),
                          Text("Payment", style: TextStyle(color: Colors.black, fontSize: vpH*0.025),)
                        ],
                      ),
                    ],
                  ),
